...
default_args={
    "owner": "ramesh.babuv@ul.com,Open in Cloud IDE",
}

@dag(
    default_args=default_args,
    schedule=None,
    start_date=pendulum.from_format("2025-02-19", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "ramesh.babuv@ul.com": "mailto:ramesh.babuv@ul.com",
        "Open in Cloud IDE": "https://cloud.astronomer.io/cm78zcxix0kpk01m9a3k4iet0/cloud-ide/cm7c6el7m19k101m9gkb069w8/cm7c6elqa19y701q43n2w33eb",
    },
)
